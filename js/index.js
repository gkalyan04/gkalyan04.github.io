            ...
            case 'IcosahedronGeometry':
                if (currentcolor == 0xF66120) {
                    if (planetViewed == 0) {
                        ...
                        description.innerHTML = "Bharati Vidyapeeth's College of Engineering New Delhi Class of <span>2021</span><br/><a target='_blank' href='https://drive.google.com/file/d/1ni2ONnrmSoAA4fJYvDytUZzXLWACsCzR/view?usp=sharing'>Offline Resume</a><br/><br/><div>Click on the other planets to learn more ...<div>";
                    }
                ...
                if (currentcolor == 0x26D7E7) {
                    if (planetViewed == 1 || planetViewed==3 || planetViewed==4) {
                        ...
                        subtitle.innerHTML = "Since <span>September 2017</span>.";
                        description.innerHTML = "You can find all my experiments here :  <br/><a target='_blank' href='https://github.com/gkalyan04?tab=repositories'>my Repo's</a><br/><br/><div>Click on the other planets to learn more ...<div>";
                   ...
                   if (currentcolor == 0xffc12d) {
                    if (planetViewed == 1 || planetViewed==2 || planetViewed==4) {
                        planetViewed = 3;
                        info.innerHTML = '<span id="couleur">Janani</span> Project : <a target="_blank" href="https://github.com/gkalyan04/Janani" style="font-size: 22px; color: white;">Github <a> ';
                         document.getElementById('couleur').style.color="#ffc12d";
                        subtitle.innerHTML = "Since <span>January 2019</span>.";
                        description.innerHTML = "Mobile App for Pregnant Ladies in India<br/><br/><div>Click on the other planets to learn more ...<div>";
